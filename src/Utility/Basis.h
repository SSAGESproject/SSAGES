...
namespace SSAGES
{
    ...
    public: 
		...
		static BasisFunction* Build(const Json::Value& json, const std::string& path, const int nbins);
    ...
    public:
        ...
        static Chebyshev* Build(const Json::Value& json, const std::string& path, const int nbins);
    ...
    public:
        ...
        static Legendre* Build(const Json::Value& json, const std::string& path, const int nbins);
    };
